...
void f()
{
  __getStandardConversion("abc", (char const*)0, SC_ARRAY_TO_PTR|SC_QUAL_CONV);
  __getStandardConversion(L"abc", (wchar_t const*)0, SC_ARRAY_TO_PTR|SC_QUAL_CONV);
  __getStandardConversion("abc", (char*)0, SC_ARRAY_TO_PTR);
}
