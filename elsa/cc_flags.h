...
enum CVFlags {
  ...
  CV_SHIFT_AMOUNT = 8,     // shift right this many bits before counting for cvFlagNames
...
enum DeclFlags {
  ...
  DF_FORWARD     = 0x01000000,    // for syntax which only provides a forward declaration
