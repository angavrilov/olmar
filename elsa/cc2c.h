...
public:      // types 
  ...
  class TypedefEntry {
  public:    // data
    // Pointer to a CType object that appears in the input AST.
    CType *type;
  ...
  public:    // funcs
    // for OwnerKHashTable
    static CType const *getType(TypedefEntry *entry);
  };
...
public:      // data
  ...
  // Set of typedefs created so far, identified by the CType they
  // denote.
  OwnerKHashTable<TypedefEntry, CType> typedefs;
...
public:      // funcs
  ...
  TypeSpecifier *makeTypeSpecifier(CType *t);
