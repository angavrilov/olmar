...
string CTypePrinter::print(CType const *type)
{
...
string CTypePrinter::print(CType const *type, char const *name)
{
...
string CTypePrinter::printRight(CType const *type, bool innerParen)
{
  // roll our own virtual dispatch
  switch(type->getTag()) {
  ...
  case CType::T_DEPENDENTSIZEDARRAY: return printRight(type->asDependentSizedArrayTypeC(), innerParen);
  }
}

string CTypePrinter::printLeft(CType const *type, bool innerParen)
{
  // roll our own virtual dispatch
  switch(type->getTag()) {
  default: xfailure("illegal tag");
  ...
  case CType::T_DEPENDENTSIZEDARRAY: return printLeft(type->asDependentSizedArrayTypeC(), innerParen);
  }
}
