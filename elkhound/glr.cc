...
void GLR::printConfig() const
{
  ...
  // I'm going to say that 'enabled' is the higher-performance setting,
  // because it *enables* other important compressions, even though by
  // itself it actually makes things slower.
