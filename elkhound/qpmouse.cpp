...
# 212 "/usr/src/linux/include/linux/module.h"
...
# 257 "/usr/src/linux/include/linux/module.h"
...
# 282 "/usr/src/linux/include/linux/module.h"
...
static int __attribute__ ((__section__ (".text.init")))  probe_qp(void)
{
	outb_p(0x55, 0x2fa);			 
	outb_p(0xaa, 0x3fa);			 
	outb_p(0x36, 0x3fa);			 
...
int __attribute__ ((__section__ (".text.init")))  qpmouse_init(void)
{
	if (!probe_qp())
		return - 5 ;
